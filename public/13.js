...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mixins: [Object(_mixins_load_sections__WEBPACK_IMPORTED_MODULE_1__["default"])(['slider-home', 'home-parallax', 'home-video-face', 'home-video', 'affiliates', 'social-media'])],
  props: {
    id: {
      type: String,
      "default": 'home'
  ...
  return {
    ...
    components: sections.reduce(function (acc, cur) {
      ...
      acc["Section".concat(name)] = function () {
        return __webpack_require__("./resources/js/views/sections lazy recursive ^\\.\\/.*\\.vue$")("./".concat(name, ".vue"));
      };
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _Index_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Index.vue?vue&type=script&lang=js& */ "./resources/js/views/home/Index.vue?vue&type=script&lang=js&");
...
/***/ "./resources/js/views/sections lazy recursive ^\\.\\/.*\\.vue$":
/*!*************************************************************************!*\
  !*** ./resources/js/views/sections lazy ^\.\/.*\.vue$ namespace object ***!
  \*************************************************************************/
...
var map = {
	...
	"./Features.vue": [
		"./resources/js/views/sections/Features.vue",
		24
	],
	"./Hero.vue": [
	...
	"./HomeParallax.vue": [
		"./resources/js/views/sections/HomeParallax.vue",
		15
	],
	"./HomeVideo.vue": [
		"./resources/js/views/sections/HomeVideo.vue",
		19
	],
	"./HomeVideoFace.vue": [
...
webpackAsyncContext.id = "./resources/js/views/sections lazy recursive ^\\.\\/.*\\.vue$";
